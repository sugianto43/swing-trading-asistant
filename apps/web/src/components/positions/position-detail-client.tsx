        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div>
              ...
              <dd className="text-lg font-semibold font-mono tabular-nums">{position.quantity_open}</dd>
            </div>
            <div>
              <dt className="text-xs text-muted-foreground">Avg entry price</dt>
              <dd className="text-lg font-semibold font-mono tabular-nums">
                {position.avg_entry_price ?? "—"}
              </dd>
            </div>
            <div>
              <dt className="text-xs text-muted-foreground">Realized P&L</dt>
              <dd className="text-lg font-semibold font-mono tabular-nums">{position.realized_pnl}</dd>
            </div>
            <div>
              ...
              <TableBody>
                {executionsQuery.data.map((execution) => (
                  <TableRow key={execution.id}>
                    ...
                    <TableCell className="text-right font-mono tabular-nums">{execution.quantity}</TableCell>
                    <TableCell className="text-right font-mono tabular-nums">{execution.price}</TableCell>
                    <TableCell className="text-right font-mono tabular-nums">{execution.fee}</TableCell>
