...
## Objective
Build the Market Overview and Top Swing Candidates screens (MASTER-PRD §14), consuming Phase 9's breadth/regime/sector-performance endpoints and Phase 4's scanner endpoints, plus an instrument detail view surfacing Phase 3's indicators.
